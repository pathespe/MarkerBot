...
def logout():
    ...
    return redirect('https://%s/v2/logout?returnTo=%s&client_id=%s' % ('arupdigital.au.auth0.com', base_url, 'xXpLrCXjZL4Almq312RFRVP3ElIcUOU0'))
...
def callback_handling():
    ...
    get_token = GetToken('arupdigital.au.auth0.com')
    auth0_users = Users('arupdigital.au.auth0.com')
    token = get_token.authorization_code('xXpLrCXjZL4Almq312RFRVP3ElIcUOU0',
                                         'f_xX_MLJZFtL9o-B4G2gJU6Uelff18hFfW1Isk2C2efekMFcFmOIN3Pd0Z1Hz0nk', code, 'https://YOUR_APP/callback')
